...
{
	m_pImgTab = I8SkinCtrl_ns::I8_GetSkinImage(TEXT("Skin/Wnd/fav/背景_收藏夹标签_1px.png"));
...
BOOL CFavPanel::OnInitDialog()
{
	...
	m_btnFav.SetTextStyle(DEFAULT_FONT_NAME, 14, RGB(0, 0, 0), RGB(0, 0, 0), 
		RGB(0, 0, 0), RGB(0, 0, 0), I8SkinCtrl_ns::CI8OldButton::BTEXT_CENTER, TRUE);
	...
	CBitmap* pIco01 = I8SkinCtrl_ns::I8_GetSkinImage(TEXT("Skin/Wnd/fav/ico01.png"));
	CBitmap* pIco02 = I8SkinCtrl_ns::I8_GetSkinImage(TEXT("Skin/Wnd/fav/ico02.png"));
...
BOOL CFavPanel::OnEraseBkgnd( CDC* pDC )
{
	...
	for (int i = 0; i <= rtClient.Width()/50; ++i)
	{
		...
		I8SkinCtrl_ns::I8_DrawImage(pDC, m_pImgTab, rtTab);
	}
	return TRUE;
}

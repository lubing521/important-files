...
BOOL CBarOnlineApp::InitInstance()
{
    ...
    TCHAR szSkinDirectory[MAX_PATH] = {0};
    GetModuleFileName(NULL, szSkinDirectory, MAX_PATH);
    PathRemoveFileSpec(szSkinDirectory);
    PathAddBackslash(szSkinDirectory);
    I8SkinCtrl_ns::I8_InitSkinCtrl(CString(szSkinDirectory) + _T("Skin\\") + strSkinFile);

...
BOOL CRBPopAdvDlg::OnInitDialog()
{
	...
	CString strUrl;
	strUrl.Format(TEXT("http://ads.i8.com.cn/ad/client/adbar09_ct.html?nid=%lu&oemid=%lu&cmac=%s&ProductID=&ProductName="), I8CD_GetInternetBarID(), I8CD_GetChannelsID(), LPCTSTR(I8CD_GetMacAddr()));

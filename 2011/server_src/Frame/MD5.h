...
namespace i8desk
{
	void __stdcall MD5Encode(const void* data, size_t ByteLen, LPTSTR md5)
	{
		MD5_CTX		  context	  = {0};
	...
	void CalcCrc32(unsigned char byte, unsigned long& dwCrc32)
	{
		dwCrc32 = ((dwCrc32) >> 8) ^ g_Crc32Table[(byte) ^ ((dwCrc32) & 0x000000FF)];
	}

	unsigned long __stdcall CalBlockCrc(char* data, size_t length)
	{

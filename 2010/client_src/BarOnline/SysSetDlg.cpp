...
BOOL CSysSetDlg::OnInitDialog()
{
	...
	m_btnCaption.SetTextStyle(DEFAULT_FONT_NAME, 16, RGB(0, 0, 0), RGB(0, 0, 0), RGB(0, 0, 0), RGB(0, 0, 0),  CButtonEx::BTEXT_LEFT, TRUE);
	...
	m_btnSvrIp.SetTextStyle(DEFAULT_FONT_NAME, 12, RGB(0, 0, 0), RGB(0, 0, 0), RGB(0, 0, 0), RGB(0, 0, 0), CButtonEx::BTEXT_LEFT, TRUE);
	...
	m_btnAreaSet.SetTextStyle(DEFAULT_FONT_NAME, 12, RGB(0, 0, 0), RGB(0, 0, 0), RGB(0, 0, 0), RGB(0, 0, 0), CButtonEx::BTEXT_LEFT, TRUE);
	...
	if (!bCanOpHy)
	{
		...
		m_btnAdd.SetTextStyle(DEFAULT_FONT_NAME, 12, RGB(127, 127, 127), RGB(127, 127, 127),
			RGB(127, 127, 127), RGB(127, 127, 127), CButtonEx::BTEXT_CENTER);
...
BOOL CSysSetDlg::OnEraseBkgnd(CDC* pDC)
{
	CRect rc;
	GetClientRect(&rc);
	AfxDrawImage(pDC, TEXT("Skin/Wnd/SysSet/背景_系统设置.png"), rc);

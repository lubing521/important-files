...
#define RTDATASVR_PLUG_NAME			TEXT("RTDataSvr")		//数据库缓存组件
...
#define OPT_M_FAVLIST				TEXT("mfavlist")		//中心控制的收藏夹列表
...
#define CLASS_WY_GUID	TEXT("{17F2FFB5-B4DC-42ce-B424-E17CFF1279B5}")  //网页游戏	 //10版本新增类别
...
#define CLASS_SP_GUID	TEXT("{D5443BC8-7839-4ce3-A56A-1018CE19800D}")	//游戏视频	 //10版本去掉了这个类别
...
//#define DEFUALT_MUSIC	TEXT("网吧音乐")
#define DEFAULT_VIDEO	TEXT("网吧影音")

//#define DEFUALT_MUSIC_GUID	TEXT("{AE1BE6A9-5163-465b-81B2-F00BDB92AE9D}")
#define DEFAULT_VIDEO_GUID	TEXT("{926B9BAD-855F-442b-842E-68A9EDD0AD38}")

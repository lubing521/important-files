...
BOOL CGongGaoDlg::OnInitDialog()
{
	...
	m_btnWelcome.SetTextStyle(DEFAULT_FONT_NAME, 16, 
		RGB(255, 255, 0), RGB(255, 255, 0), RGB(255, 255, 0), RGB(255, 255, 0), CButtonEx::BTEXT_LEFT, TRUE);
	...
	m_btnContext.SetTextStyle(szFontName, _ttoi(szFontSize), clr, clr, clr, clr, CButtonEx::BTEXT_LEFT,
		dwFlag & 0x1, dwFlag & 0x2, dwFlag & 0x4, dwFlag & 0x8, CButtonEx::BTYPE_NBCONTENT, FALSE);
	...
	m_btnNbInfo.SetTextStyle(DEFAULT_FONT_NAME, 12, RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), 
		RGB(255, 255, 255), CButtonEx::BTEXT_CENTER, TRUE);
...
void CGongGaoDlg::OnPaint()
{
	...
	GetClientRect(&rc);
	CPaintDC dc(this);
	AfxDrawImage(&dc, TEXT("Skin/Wnd/GongGao/背景_网吧公告.png"), rc);
}

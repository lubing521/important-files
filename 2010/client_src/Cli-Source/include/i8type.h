...
#define MASK_TSYNCTASK_SYNCTYPE		(1LL << 2L)
#define MASK_TSYNCTASK_SYNCIP		(1LL << 3L)
#define MASK_TSYNCTASK_VDISKIP		(1LL << 4L)
#define MASK_TSYNCTASK_UPDATEIP		(1LL << 5L)
#define MASK_TSYNCTASK_DESTDRV		(1LL << 6L)
#define MASK_TSYNCTASK_BALANCETYPE	(1LL << 7L)

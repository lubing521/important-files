...
#include "stdafx.h"
#define CRASH_DUMP_FILE		TEXT("I8VDiskSvr")
...
public:
	CI8VDiskSvr():CWin32Svr(SERVICE_NAME, SERVICE_DISCRIPTION) 
	{
...
public:
	...
	virtual DWORD OnStart()
	{
		...
		{
			CWin32Svr::StopService("i8vdisksvr");
			CWin32Svr::RemoveService("i8vdisksvr");
		}
...
void StartProcess(LPCTSTR lpszPath)
{
	...
	i8desk::std_string tmp = i8desk::GetAppPath() + lpszPath;

...
namespace i8desk
{
	namespace filesystem
	{
		...
		public:
			...
			i8desk::std_string GetFileName() const
			{
				assert(m_hFind != NULL);

				i8desk::std_string ret;
			...
			i8desk::std_string GetFilePath() const
			{
				assert(m_hFind != NULL);

				i8desk::std_string strResult = m_lpszRoot;
			...
			i8desk::std_string GetFileTitle() const
			{
				assert(m_hFind != NULL);
			...
			i8desk::std_string GetFileURL() const
			{
				assert(m_hFind != NULL);

				i8desk::std_string strResult(_T("file://"));
				strResult += GetFilePath();
				return strResult;
			}

			i8desk::std_string GetRoot() const
			{
				assert(m_hFind != NULL);

				i8desk::std_string str = m_lpszRoot;
				return str;
			}
